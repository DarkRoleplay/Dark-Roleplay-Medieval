...
//	public static void init(FMLInitializationEvent event) {}
	...
	private static void registerAirRecipes(){
		...
		CraftingRegistry.registerRecipe(Blocks.AIR,"sittables",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "log_chair_spruce"),
			new ItemStack[]{new ItemStack(DRPMedievalBlocks.LOG_CHAIR_SPRUCE, 1, 0)},new ItemStack[]{new ItemStack(Blocks.LOG, 1, 1)}), false);
		CraftingRegistry.registerRecipe(Blocks.AIR,"sittables",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "log_chair_birch"),
			new ItemStack[]{new ItemStack(DRPMedievalBlocks.LOG_CHAIR_BIRCH, 1, 0)},new ItemStack[]{new ItemStack(Blocks.LOG, 1, 2)}), false);
		CraftingRegistry.registerRecipe(Blocks.AIR,"sittables",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "log_chair_jungle"),
			new ItemStack[]{new ItemStack(DRPMedievalBlocks.LOG_CHAIR_JUNGLE, 1, 0)},new ItemStack[]{new ItemStack(Blocks.LOG, 1, 3)}), false);
		CraftingRegistry.registerRecipe(Blocks.AIR,"sittables",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "log_chair_dark_oak"),
			new ItemStack[]{new ItemStack(DRPMedievalBlocks.LOG_CHAIR_DARK_OAK, 1, 0)},new ItemStack[]{new ItemStack(Blocks.LOG2, 1, 1)}), false);
		CraftingRegistry.registerRecipe(Blocks.AIR,"sittables",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "log_chair_acacia"),
		...
		CraftingRegistry.registerRecipe(Blocks.AIR,"decorative",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "barrel_water_spruce"),
		...
		CraftingRegistry.registerRecipe(Blocks.AIR,"decorative",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "barrel_water_birch"),
		...
		CraftingRegistry.registerRecipe(Blocks.AIR,"decorative",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "barrel_water_jungle"),
		...
		CraftingRegistry.registerRecipe(Blocks.AIR,"decorative",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "barrel_water_dark_oak"),
		...
		CraftingRegistry.registerRecipe(Blocks.AIR,"decorative",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "barrel_water_acacia"),
		...
		CraftingRegistry.registerRecipe(Blocks.AIR,"decorative",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "barrel_gunpowder_oak"),
		...
		CraftingRegistry.registerRecipe(Blocks.AIR,"decorative",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "barrel_gunpowder_spruce"),
		...
		CraftingRegistry.registerRecipe(Blocks.AIR,"decorative",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "barrel_gunpowder_birch"),
		...
		CraftingRegistry.registerRecipe(Blocks.AIR,"decorative",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "barrel_gunpowder_jungle"),
		...
		CraftingRegistry.registerRecipe(Blocks.AIR,"decorative",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "barrel_gunpowder_dark_oak"),
		...
		CraftingRegistry.registerRecipe(Blocks.AIR,"decorative",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "barrel_gunpowder_acacia"),
		...
		CraftingRegistry.registerRecipe(Blocks.AIR,"building",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "clean_plank_spruce"),
			new ItemStack[]{new ItemStack(DRPMedievalBlocks.CLEAN_PLANKS, 1, 1)},new ItemStack[]{new ItemStack(Blocks.PLANKS, 1, 1)}), false);
		CraftingRegistry.registerRecipe(Blocks.AIR,"building",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "clean_plank_birch"),
			new ItemStack[]{new ItemStack(DRPMedievalBlocks.CLEAN_PLANKS, 1, 2)},new ItemStack[]{new ItemStack(Blocks.PLANKS, 1, 2)}), false);
		CraftingRegistry.registerRecipe(Blocks.AIR,"building",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "clean_plank_jungle"),
			new ItemStack[]{new ItemStack(DRPMedievalBlocks.CLEAN_PLANKS, 1, 3)},new ItemStack[]{new ItemStack(Blocks.PLANKS, 1, 3)}), false);
		CraftingRegistry.registerRecipe(Blocks.AIR,"building",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "clean_plank_dark_oak"),
			new ItemStack[]{new ItemStack(DRPMedievalBlocks.CLEAN_PLANKS, 1, 4)},new ItemStack[]{new ItemStack(Blocks.PLANKS, 1, 5)}), false);
		CraftingRegistry.registerRecipe(Blocks.AIR,"building",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "clean_plank_acacia"),
			new ItemStack[]{new ItemStack(DRPMedievalBlocks.CLEAN_PLANKS, 1, 5)},new ItemStack[]{new ItemStack(Blocks.PLANKS, 1, 4)}), false);
		
		CraftingRegistry.registerRecipe(Blocks.AIR,"building",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "brick_diorite"),
			new ItemStack[]{new ItemStack(DRPMedievalBlocks.DIORITE_BRICKS, 4, 0)},new ItemStack[]{new ItemStack(Blocks.STONE, 4, 4)}), false);
		CraftingRegistry.registerRecipe(Blocks.AIR,"building",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "pillar_diorite"),
			new ItemStack[]{new ItemStack(DRPMedievalBlocks.DIORITE_PILLAR, 3, 0)},new ItemStack[]{new ItemStack(Blocks.STONE, 3, 4)}), false);
		CraftingRegistry.registerRecipe(Blocks.AIR,"building",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "brick_granite"),
			new ItemStack[]{new ItemStack(DRPMedievalBlocks.GRANITE_BRICKS, 4, 0)},new ItemStack[]{new ItemStack(Blocks.STONE, 4, 2)}), false);
		CraftingRegistry.registerRecipe(Blocks.AIR,"building",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "pillar_granite"),
			new ItemStack[]{new ItemStack(DRPMedievalBlocks.GRANITE_PILLAR, 3, 0)},new ItemStack[]{new ItemStack(Blocks.STONE, 3, 2)}), false);
		CraftingRegistry.registerRecipe(Blocks.AIR,"building",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "brick_andesite"),
			new ItemStack[]{new ItemStack(DRPMedievalBlocks.ANDESITE_BRICKS, 4, 0)},new ItemStack[]{new ItemStack(Blocks.STONE, 4, 6)}), false);
		CraftingRegistry.registerRecipe(Blocks.AIR,"building",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "pillar_andesite"),
			new ItemStack[]{new ItemStack(DRPMedievalBlocks.ANDESITE_PILLAR, 3, 0)},new ItemStack[]{new ItemStack(Blocks.STONE, 3, 6)}), false);
		
		CraftingRegistry.registerRecipe(Blocks.AIR,"building",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "snow_brick"),
			new ItemStack[]{new ItemStack(DRPMedievalBlocks.SNOW_BRICKS, 1, 0)},new ItemStack[]{new ItemStack(Blocks.SNOW, 1, 0)}), false);
		CraftingRegistry.registerRecipe(Blocks.AIR,"building",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "packed_ice_brick"),
		...
		CraftingRegistry.registerRecipe(Blocks.AIR, "crafting_stations",new SimpleRecipe( new ResourceLocation(DRPMedievalInfo.MODID, "anvil"),
			new ItemStack[]{new ItemStack(DRPMedievalBlocks.ANVIL, 1, 0)}, new ItemStack[]{new ItemStack(Items.IRON_INGOT,32,0)}), false);
		CraftingRegistry.registerRecipe(Blocks.AIR, "crafting_stations",new SimpleRecipe( new ResourceLocation(DRPMedievalInfo.MODID, "mortar"),
	...
	private static void registerSpinningWheelRecipes(){
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.SPINNING_WHEEL,"crafting_materials",new SimpleRecipe(new ResourceLocation(DRPMedievalInfo.MODID, "simple_string"),
	...
	private static void registerAnvilRecipes(){
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.ANVIL, "crafting_materials",new SimpleRecipe( new ResourceLocation(DRPMedievalInfo.MODID, "tap"),
			new ItemStack[]{new ItemStack(DRPMedievalItems.TAP, 2, 0)}, new ItemStack[]{new ItemStack(Items.IRON_INGOT, 1, 0)}), false);
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.ANVIL, "decorative",new SimpleRecipe( new ResourceLocation(DRPMedievalInfo.MODID, "torch_holder_empty"),
		...
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.ANVIL, "decorative",new SimpleRecipe( new ResourceLocation(DRPMedievalInfo.MODID, "iron_chain"),
			new ItemStack[]{new ItemStack(DRPMedievalBlocks.CHAIN, 1, 0)}, new ItemStack[]{new ItemStack(Items.IRON_INGOT,1,0)}), false);
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.ANVIL, "decorative",new SimpleRecipe( new ResourceLocation(DRPMedievalInfo.MODID, "iron_hook"),
			new ItemStack[]{new ItemStack(DRPMedievalBlocks.IRON_HOOK, 1, 0)}, new ItemStack[]{new ItemStack(Items.IRON_INGOT,1,0)}), false);
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.ANVIL, "decorative",new SimpleRecipe( new ResourceLocation(DRPMedievalInfo.MODID, "golden_ship_bell"),
	...
	private static void registerCauldronRecipes(){
		...
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.CAULDRON, "soups",new SimpleRecipe( new ResourceLocation(DRPMedievalInfo.MODID, "mushroom_stew"),
