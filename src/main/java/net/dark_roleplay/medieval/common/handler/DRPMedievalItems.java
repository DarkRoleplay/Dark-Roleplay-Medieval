...
//		THICK_CHAIN = (ItemRope) new ItemRope("thick_chain", "ropes").setCreativeTab(DRPMedievalCreativeTabs.drpmedievalMiscTab),
		...
		register(reg, DRPMedievalCreativeTabs.FOOD,
			...
			new DRPFood(6, 0.6F, "fish_cooked_catfish", "food/fish", 64),
			new DRPFood(2, 0.3F, "fish_raw_catfish", "food/fish", 64),
			new DRPFood(1, 0.1F, "blue_berrys", "food/fruits", 64),
			...
			new DRPFood(6, 0.4F,"meat_cooked_wolf", "food/meat", 64),
			new DRPFood(2, 0.15F,"meat_raw_wolf", "food/meat", 64),
