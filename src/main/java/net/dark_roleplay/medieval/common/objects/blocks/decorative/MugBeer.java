...
public class MugBeer extends Block {
	...
	public IBlockState getStateFromMeta(int meta) {
		...
		switch (meta) {
			case 0:
				return this.getDefaultState().withProperty(MugBeer.FACING, EnumFacing.NORTH);
			case 1:
				return this.getDefaultState().withProperty(MugBeer.FACING, EnumFacing.EAST);
			case 2:
				return this.getDefaultState().withProperty(MugBeer.FACING, EnumFacing.SOUTH);
			case 3:
				return this.getDefaultState().withProperty(MugBeer.FACING, EnumFacing.WEST);
			default:
				return this.getDefaultState().withProperty(MugBeer.FACING, EnumFacing.NORTH);
		}
	}
	...
	public int getMetaFromState(IBlockState state) {
		...
		EnumFacing facing = state.getValue(MugBeer.FACING);
	...
	protected BlockStateContainer createBlockState() {
		...
		return new BlockStateContainer(this, new IProperty[] {MugBeer.FACING});
	}
