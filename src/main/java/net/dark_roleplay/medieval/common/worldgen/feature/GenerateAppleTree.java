package net.dark_roleplay.medieval.common.worldgen.feature;
...
//			world.setBlockState(pos.add(0,i,0),DRPMedievalBlocks.LOGS_1.getDefaultState());
//		}
//		
//		for(int y = 0; y < 2; y ++){
//			for(int x = 0; x < 5; x ++){
...
//								world.setBlockState(pos2, DRPMedievalBlocks.LEAVES_1.getDefaultState());
//							}
//					}else{
//						if(world.getBlockState(pos2).getBlock() == Blocks.AIR){
//							world.setBlockState(pos2, DRPMedievalBlocks.LEAVES_1.getDefaultState());
...
//			int trys = 0;
//			
//			while(world.getBlockState(pos.add(x, height  - 1 ,z)).getBlock() != DRPMedievalBlocks.LEAVES_1 && world.getBlockState(pos.add(x, height - 2 ,z)).getBlock() != Blocks.AIR && trys != 5){
