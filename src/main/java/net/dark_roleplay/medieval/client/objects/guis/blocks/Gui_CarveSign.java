package net.dark_roleplay.medieval.client.objects.guis.blocks;
...
public class Gui_CarveSign extends GuiScreen{
	...
	public Gui_CarveSign(TE_ShopSign te){
	    ...
	    this.imgLoc = Minecraft.getMinecraft().getTextureManager().getDynamicTextureLocation("gui_carve_carving", new DynamicTexture(this.img));
	}
