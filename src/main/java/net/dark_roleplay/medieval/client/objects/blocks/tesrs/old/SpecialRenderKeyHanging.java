...
public class SpecialRenderKeyHanging extends TileEntitySpecialRenderer<TileEntityKeyHanging> {

	private static final ResourceLocation texture = new ResourceLocation(References.MODID, "textures/old_blocks/block_key_hanging.png");
	...
	@Override
	public void render(TileEntityKeyHanging tileentity, double x, double y, double z, float partialTicks, int destroyStage, float alpha){
		GL11.glPushMatrix();
