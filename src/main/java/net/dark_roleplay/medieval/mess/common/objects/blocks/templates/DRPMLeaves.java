package net.dark_roleplay.medieval.mess.common.objects.blocks.templates;

import java.util.Random;

import net.dark_roleplay.medieval.mess.common.objects.blocks.building.Planks1;
...
public abstract class DRPMLeaves extends Block implements net.minecraftforge.common.IShearable {
	...
	public abstract Planks1.EnumType getWoodType(int meta);
