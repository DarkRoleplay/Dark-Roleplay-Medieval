package net.dark_roleplay.medieval.mess.common.objects.blocks.decorative.rope_fence;

import java.util.List;

import javax.annotation.Nullable;

import net.dark_roleplay.medieval.mess.api.blocks.properties.UnlistedPropertyInteger;
