...
import net.dark_roleplay.medieval.mess.common.objects.items.BarkAndGlue;
import net.dark_roleplay.medieval.mess.common.objects.items.DRPMStew;
import net.dark_roleplay.medieval.mess.common.objects.items.FlintKnife;
import net.dark_roleplay.medieval.mess.common.objects.items.Instrument;
import net.dark_roleplay.medieval.mess.common.objects.items.Key;
import net.dark_roleplay.medieval.mess.common.objects.items.Lock;
import net.dark_roleplay.medieval.mess.common.objects.items.PoleWeapon;
import net.dark_roleplay.medieval.mess.common.objects.items.StreetStomper;
import net.dark_roleplay.medieval.mess.common.objects.items.Telescope;
import net.dark_roleplay.medieval.mess.common.objects.items.WarHorn;
import net.dark_roleplay.medieval.mess.common.objects.items.blocks.HangingBridge_Item;
import net.dark_roleplay.medieval.mess.common.objects.items.blocks.ItemFirewood;
import net.dark_roleplay.medieval.mess.common.objects.items.blocks.ItemMultiBlock;
