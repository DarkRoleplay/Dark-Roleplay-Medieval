package net.dark_roleplay.medieval.objects.items;
...
public class DRPItemBlock extends DRPItem{
	
    protected final Block block;
	
	public DRPItemBlock(String name, Block block, int stackSize, String... subNames) {
		this(name, block, null, stackSize, subNames);
	}
    
	public DRPItemBlock(String name, Block block, String itemFolder, int stackSize, String... subNames) {
