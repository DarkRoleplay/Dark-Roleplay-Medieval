...
import net.dark_roleplay.medieval.objects.blocks.decoration.flower_container.TileEntityFlowerContainer.FlowerData;
...
public class SpecialRendererFlowerContainer extends TileEntitySpecialRenderer<TileEntityFlowerContainer>{ // extends FastTESR<FlowersTileEntity> {

	@Override
	public final void render(TileEntityFlowerContainer te, double x, double y, double z, float partialTicks, int destroyStage, float partial) {
		...
		boolean rotate90 = state.getValue(MedievalBlockProperties.AXIS_HORIZONTAL) == EnumFacing.Axis.X;
...
//		GlStateManager.popMatrix();
	...
	@Override
	public void renderTileEntityFast(TileEntityFlowerContainer te, double x, double y, double z, float partialTicks, int destroyStage, float partial, BufferBuilder buffer) {
