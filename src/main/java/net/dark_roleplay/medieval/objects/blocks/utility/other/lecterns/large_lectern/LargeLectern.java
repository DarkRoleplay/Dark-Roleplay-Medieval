package net.dark_roleplay.medieval.objects.blocks.utility.other.lecterns.large_lectern;
...
public class LargeLectern extends Block implements LargeBlock{
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess world, BlockPos pos){
		if(state.getValue(IS_TOP)){
			TileEntityLectern te = (TileEntityLectern) world.getTileEntity(pos);
			if((te != null))
...
//	}
	...
	public void breakBlock(World world, BlockPos pos, IBlockState state) {
		...
		if(tileEntity instanceof TileEntityLectern){
			TileEntityLectern te = (TileEntityLectern) tileEntity;
