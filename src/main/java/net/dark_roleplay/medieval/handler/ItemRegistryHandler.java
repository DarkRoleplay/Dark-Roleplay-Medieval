...
public class ItemRegistryHandler {
	...
	public static final void registerItems(RegistryEvent.Register<Item> registryEvent) {
		...
		registerItems(reg, MedievalCreativeTabs.FOOD,
			...
			new DRPFood(2, 0.4F, "turnip", ResourceFolders.Items.VEGETABLES + "/turnip", 64),
			new DRPFood(2, 0.4F, "eggplant", ResourceFolders.Items.VEGETABLES + "/eggplant", 64),
			new DRPFood(2, 0.4F, "hops", ResourceFolders.Items.VEGETABLES + "/hops", 64),
