...
//	public static void init(FMLInitializationEvent event) {}
	...
	private static void registerSpinningWheelRecipes(){
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.SPINNING_WHEEL,"crafting_materials",new SimpleRecipe(new ResourceLocation(DarkRoleplayMedieval.MODID, "simple_string"),
	...
	private static void registerMortarRecipes(){
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.MORTAR, "crafting_materials",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "wheat_flour"),
			new ItemStack[]{new ItemStack(DRPMedievalItems.FlourWheat, 1, 0)}, new ItemStack[]{new ItemStack(Items.WHEAT, 1, 0)}), false);
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.MORTAR, "crafting_materials",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "wheat_barley"),
		...
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.MORTAR, "crafting_materials",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "bone_meal"),
			new ItemStack[]{new ItemStack(Items.DYE, 4, 15)}, new ItemStack[]{new ItemStack(Items.BONE, 1, 0)}), false);
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.MORTAR, "crafting_materials",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "charcoal_powder"),
			new ItemStack[]{new ItemStack(DRPMedievalItems.CHARCOAL_POWDER, 3, 0)}, new ItemStack[]{new ItemStack(Items.COAL, 1, 1)}), false);
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.MORTAR, "crafting_materials",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "gunpowder"),
	...
	private static void registerAnvilRecipes(){
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.ANVIL, "crafting_materials",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "tap"),
			new ItemStack[]{new ItemStack(DRPMedievalItems.TAP, 2, 0)}, new ItemStack[]{new ItemStack(Items.IRON_INGOT, 1, 0)}), false);
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.ANVIL, "decorative",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "torch_holder_empty"),
		...
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.ANVIL, "decorative",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "iron_chain"),
			new ItemStack[]{new ItemStack(DRPMedievalBlocks.CHAIN, 1, 0)}, new ItemStack[]{new ItemStack(Items.IRON_INGOT,1,0)}), false);
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.ANVIL, "decorative",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "iron_hook"),
			new ItemStack[]{new ItemStack(DRPMedievalBlocks.IRON_HOOK, 1, 0)}, new ItemStack[]{new ItemStack(Items.IRON_INGOT,1,0)}), false);
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.ANVIL, "decorative",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "golden_ship_bell"),
		...
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.ANVIL, "crafting_stations",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "cauldron_firepit"),
			new ItemStack[]{new ItemStack(DRPMedievalBlocks.CAULDRON, 1, 0)}, new ItemStack[]{new ItemStack(Items.IRON_INGOT,16,0)}), false);
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.ANVIL, "storage",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "crate_spruce"),
	...
	private static void registerChoppingBlockRecipes(){
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.CHOPPING_BLOCK, "crafting_materials",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "firewood_oak"),
			new ItemStack[]{new ItemStack(DRPMedievalItems.Firewood, 4, 0)}, new ItemStack[]{new ItemStack(Blocks.LOG, 1, 0)}), false);
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.CHOPPING_BLOCK, "crafting_materials",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "firewood_spruce"),
			new ItemStack[]{new ItemStack(DRPMedievalItems.Firewood, 4, 1)}, new ItemStack[]{new ItemStack(Blocks.LOG, 1, 1)}), false);
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.CHOPPING_BLOCK, "crafting_materials",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "firewood_birch"),
			new ItemStack[]{new ItemStack(DRPMedievalItems.Firewood, 4, 2)}, new ItemStack[]{new ItemStack(Blocks.LOG, 1, 2)}), false);
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.CHOPPING_BLOCK, "crafting_materials",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "firewood_jungle"),
			new ItemStack[]{new ItemStack(DRPMedievalItems.Firewood, 4, 3)}, new ItemStack[]{new ItemStack(Blocks.LOG, 1, 3)}), false);
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.CHOPPING_BLOCK, "crafting_materials",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "firewood_dark_oak"),
			new ItemStack[]{new ItemStack(DRPMedievalItems.Firewood, 4, 4)}, new ItemStack[]{new ItemStack(Blocks.LOG2, 1, 1)}), false);
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.CHOPPING_BLOCK, "crafting_materials",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "firewood_acacia"),
	...
	private static void registerCauldronRecipes(){
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.CAULDRON, "soups",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "chicken_stew"),
		...
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.CAULDRON, "soups",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "cod_stew"),
		...
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.CAULDRON, "soups",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "veggie_stew"),
		...
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.CAULDRON, "soups",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "pumpkin_stew"),
		...
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.CAULDRON, "soups",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "rabbit_stew"),
		...
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.CAULDRON, "soups",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "beetroot_stew"),
		...
		CraftingRegistry.registerRecipe(DRPMedievalBlocks.CAULDRON, "soups",new SimpleRecipe( new ResourceLocation(DarkRoleplayMedieval.MODID, "mushroom_stew"),
