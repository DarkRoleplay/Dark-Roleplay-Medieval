...
public class DungeonChest extends BlockContainer{
	...
	public void setBlockBoundsBasedOnState(IBlockAccess worldIn, BlockPos pos){
		...
		if(facing.equals(EnumFacing.NORTH)) this.setBlockBounds(0.0625F,0F,0.125F,0.9375F,0.75F,0.875F);
		else if (facing.equals(EnumFacing.EAST)) this.setBlockBounds(0.125F,0F,0.0625F,0.875F,0.75F,0.9375F);
		else if(facing.equals(EnumFacing.SOUTH)) this.setBlockBounds(0.0625F,0F,0.125F,0.9375F,0.75F,0.875F);
