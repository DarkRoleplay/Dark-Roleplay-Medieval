...
public class TorchHolderEmpty extends Block{
	...
	public IBlockState getStateFromMeta(int meta)
    {
		int i = meta;
		if(i < 4){
			if(i == 0) return this.getDefaultState().withProperty(FACING, EnumFacing.NORTH).withProperty(AddonLighter, false).withProperty(AddonTrap, false);
			else if(i == 1) return this.getDefaultState().withProperty(FACING, EnumFacing.EAST).withProperty(AddonLighter, false).withProperty(AddonTrap, false);
			else if(i == 2) return this.getDefaultState().withProperty(FACING, EnumFacing.WEST).withProperty(AddonLighter, false).withProperty(AddonTrap, false);
			...
			i -= 4;
			if(i == 0) return this.getDefaultState().withProperty(FACING, EnumFacing.NORTH).withProperty(AddonLighter, true).withProperty(AddonTrap, false);
			else if(i == 1) return this.getDefaultState().withProperty(FACING, EnumFacing.EAST).withProperty(AddonLighter, true).withProperty(AddonTrap, false);
			else if(i == 2) return this.getDefaultState().withProperty(FACING, EnumFacing.WEST).withProperty(AddonLighter, true).withProperty(AddonTrap, false);
			...
			i -= 8;
			if(i == 0) return this.getDefaultState().withProperty(FACING, EnumFacing.NORTH).withProperty(AddonLighter, false).withProperty(AddonTrap, true);
			else if(i == 1) return this.getDefaultState().withProperty(FACING, EnumFacing.EAST).withProperty(AddonLighter, false).withProperty(AddonTrap, true);
			else if(i == 2) return this.getDefaultState().withProperty(FACING, EnumFacing.WEST).withProperty(AddonLighter, false).withProperty(AddonTrap, true);
	...
	public int getMetaFromState(IBlockState state)
    {
	 ...
	 public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer)
	    {
			if(facing.equals(facing.SOUTH)) return this.getDefaultState().withProperty(FACING, EnumFacing.SOUTH);
			else if(facing.equals(facing.WEST)) return this.getDefaultState().withProperty(FACING, EnumFacing.WEST);
			else if(facing.equals(facing.NORTH)) return this.getDefaultState().withProperty(FACING, EnumFacing.NORTH);
			else if(facing.equals(facing.EAST)) return this.getDefaultState().withProperty(FACING, EnumFacing.EAST);
