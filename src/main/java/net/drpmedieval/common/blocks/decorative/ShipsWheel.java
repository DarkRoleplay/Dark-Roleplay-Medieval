...
public class ShipsWheel   extends BlockContainer{
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess worldIn, BlockPos pos){
		...
		if(facing.equals(EnumFacing.NORTH)) this.setBlockBounds(0F,0F,0.625F,1F,1F,1F);
		else if (facing.equals(EnumFacing.EAST)) this.setBlockBounds(0F,0F,0F,0.375F,1F,1F);
		else if(facing.equals(EnumFacing.SOUTH)) this.setBlockBounds(0F,0F,0F,1F,1F,0.375F);
