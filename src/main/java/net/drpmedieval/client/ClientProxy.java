...
public class ClientProxy extends CommonProxy{
	...
	public void forceAdditionalModels(){
		ModelBakery.registerItemVariants(DRPMedievalItems.itemFirewood, new ResourceLocation[]{
				new ResourceLocation(DarkRoleplayMedieval.MODID + ":" + "itemFirewoodOak"),
				new ResourceLocation(DarkRoleplayMedieval.MODID + ":" + "itemFirewoodSpruce"),
				new ResourceLocation(DarkRoleplayMedieval.MODID + ":" + "itemFirewoodBirch"),
				new ResourceLocation(DarkRoleplayMedieval.MODID + ":" + "itemFirewoodJungle"),
				new ResourceLocation(DarkRoleplayMedieval.MODID + ":" + "itemFirewoodDarkOak"),
				new ResourceLocation(DarkRoleplayMedieval.MODID + ":" + "itemFirewoodAcacia")
				});
	}
