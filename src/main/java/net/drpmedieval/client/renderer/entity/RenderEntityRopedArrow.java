package net.drpmedieval.client.renderer.entity;

import net.drpmedieval.client.renderer.entity.RenderEntitySledge.Factory;
...
public class RenderEntityRopedArrow extends Render<EntityRopedArrow>{

    public RenderEntityRopedArrow(RenderManager renderManagerIn){
     ...
     */
    public void doRender(EntityRopedArrow entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
	...
	protected ResourceLocation getEntityTexture(EntityRopedArrow entity) {
		return new ResourceLocation(DarkRoleplayMedieval.MODID, "textures/entitys/TrainingDummy.png");
	}
	
	public static class Factory implements IRenderFactory<EntityRopedArrow> {
		@Override
		public Render<? super EntityRopedArrow> createRenderFor(RenderManager manager) {
			return new RenderEntityRopedArrow(manager);
	    }
	}
}
